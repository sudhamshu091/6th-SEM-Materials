      ...
      if (client.available()) {             // if there's bytes to read from the client,
        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (strlen(buffer) == 0) {
            ...
            server.println("<html><head><title>WiFi Web Server</title></head><body align=center>");
            server.println("<h1 align=center><font color=\"red\">Welcome to the IoT Web Server</font></h1>");
