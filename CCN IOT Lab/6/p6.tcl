...
# rtmodel is the routing model to be written to connect or disconnect a link between nodes
$ns rtmodel-at 10.0 down $n(11) $n(5) # communication link between node 11 to 5 disconnected
$ns rtmodel-at 30.0 up $n(11) $n(5)      # communication link between node 11 to 5 reconnected
$ns rtmodel-at 15.0 down $n(7) $n(6) # communication link between node 7 to 6 disconnected
$ns rtmodel-at 20.0 up $n(7) $n(6) )      # communication link between node 7 to 6 reconnected
